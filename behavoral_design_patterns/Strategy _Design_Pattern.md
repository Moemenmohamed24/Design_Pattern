...
2 ) المشكلة الثانية: صعوبة التبديل في الـ Runtime:
وصف المشكلة:
التطبيق محتاج يغير طريقة التنفيذ وهو شغال بناءً على input من المستخدم أو config، وده مش ممكن بالـ Inheritance.
